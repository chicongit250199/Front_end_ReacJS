...
class Action extends Component {
    render() {
        ...
        //                     <span className="mt-action-author">Admin</span>
        //                     <p className="mt-action-desc">Create new project</p>
        //                   </div>
        //                 </div>
        ...
        //                   <div className="mt-action-details ">
        //                     <span className="mt-action-author">Admin</span>
        //                     <p className="mt-action-desc">Create new team</p>
        //                   </div>
        //                 </div>
        //                 <div className="mt-action-datetime ">
        //                   <span className="mt-action-date">3 jun</span>
        ...
        //                   <div className="mt-action-details ">
        //                     <span className="mt-action-author">Admin</span>
        //                     <p className="mt-action-desc">Update Donald Langworth's profile</p>
        //                   </div>
        //                 </div>
        //                 <div className="mt-action-datetime ">
        //                   <span className="mt-action-date">3 jun</span>
        ...
        //                   <div className="mt-action-details ">
        //                     <span className="mt-action-author">Admin</span>
        //                     <p className="mt-action-desc">Add a new engineer</p>
        //                   </div>
        //                 </div>
        //                 <div className="mt-action-datetime ">
        //                   <span className="mt-action-date">3 jun</span>
